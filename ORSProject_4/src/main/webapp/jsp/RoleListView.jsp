<%@page import="com.rays.controller.RoleListCtl"%>
<%@page import="com.rays.util.HTMLUtility"%>
<%@page import="java.util.Iterator"%>
<%@page import="com.rays.bean.RoleBean"%>
...
<body>
	...
	<jsp:useBean id="bean" class="com.rays.bean.RoleBean" scope="request"></jsp:useBean>
