...
<%@page import="com.rays.controller.TimetableListCtl"%>
<%@page import="com.rays.util.ServletUtility"%>
<%@page import="com.rays.bean.TimeTableBean"%>
...
<body>
	...
	<div align="center">
		...
		<jsp:useBean id="bean" class="com.rays.bean.TimeTableBean"
		...
		<form action="<%=ORSView.TIMETABLE_LIST_CTL%>" method="post">
			...
			<table border="1" style="width: 100%; border: groove;">
				<tr style="background-color: #e1e6f1e3;">
					...
					<%
					if (user.getRoleId() == RoleBean.STUDENT || user.getRoleId() == RoleBean.KIOSK) {
					%>
